#!/usr/bin/env python3
"""Quick live check for the OnchainFundamentalAgent."""
...
from crypto_market_agents.agents.onchain_fundamental_agent import (  # noqa: E402
    OnchainFundamentalAgent,
)
from crypto_market_agents.clients.defillama_client import DefiLlamaClient  # noqa: E402
